...
public class SalesforceBookingRequest {
    ...
    private Boolean fsDatesCreated;
    ...
    private Boolean generateRoomingList;
    ...
    private Boolean hideFloorplans;
    ...
    private Boolean requestAR;

    @JsonProperty("Afwijkende_voorwaarden__c")
    private Boolean afwijkendeVoorwaarden;
    ...
    private Boolean hideAboutUs;

    @JsonProperty("Hide_picture_page__c")
    private Boolean hidePicturePage;

    @JsonProperty("Proforma_referentie__c")
    private String proformaReferentie;
    ...
    private Boolean individualPickup;
    ...
    public Boolean getFsDatesCreated() {
        return fsDatesCreated;
    }

    public void setFsDatesCreated(Boolean fsDatesCreated) {
        this.fsDatesCreated = fsDatesCreated;
    }
    ...
    public Boolean getGenerateRoomingList() {
        return generateRoomingList;
    }

    public void setGenerateRoomingList(Boolean generateRoomingList) {
        this.generateRoomingList = generateRoomingList;
    }
    ...
    public Boolean getExclTax() {
        return exclTax;
    }

    public void setExclTax(Boolean exclTax) {
    ...
    public Boolean getHideFloorplans() {
        return hideFloorplans;
    }

    public void setHideFloorplans(Boolean hideFloorplans) {
        this.hideFloorplans = hideFloorplans;
    }
    ...
    public Boolean getRequestAR() {
        return requestAR;
    }

    public void setRequestAR(Boolean requestAR) {
        this.requestAR = requestAR;
    }

    public Boolean getAfwijkendeVoorwaarden() {
        return afwijkendeVoorwaarden;
    }

    public void setAfwijkendeVoorwaarden(Boolean afwijkendeVoorwaarden) {
        this.afwijkendeVoorwaarden = afwijkendeVoorwaarden;
    }
    ...
    public void setImageHeader2(String imageHeader2) {
        this.imageHeader2 = imageHeader2;
    }
    ...
    public void setImageHeader3(String imageHeader3) {
        this.imageHeader3 = imageHeader3;
    }
    ...
    public void setImageHeader4(String imageHeader4) {
        this.imageHeader4 = imageHeader4;
    }
    ...
    public void setImageHeader5(String imageHeader5) {
        this.imageHeader5 = imageHeader5;
    }

    public String getImageHeader6() {
        return imageHeader6;
    }

    public void setImageHeader6(String imageHeader6) {
        this.imageHeader6 = imageHeader6;
    }

    public Boolean getGenerateOffer() {
    ...
    public Boolean getHideAboutUs() {
        return hideAboutUs;
    }

    public void setHideAboutUs(Boolean hideAboutUs) {
        this.hideAboutUs = hideAboutUs;
    }

    public Boolean getHidePicturePage() {
        return hidePicturePage;
    }

    public void setHidePicturePage(Boolean hidePicturePage) {
        this.hidePicturePage = hidePicturePage;
    }

    public String getProformaReferentie() {
        return proformaReferentie;
    }

    public void setProformaReferentie(String proformaReferentie) {
        this.proformaReferentie = proformaReferentie;
    }
    ...
    public Boolean getSendFailedReservations() {
        return sendFailedReservations;
    }

    public void setSendFailedReservations(Boolean sendFailedReservations) {
        this.sendFailedReservations = sendFailedReservations;
    }
    ...
    public Boolean getSyncWithMeetingPackage() {
        return syncWithMeetingPackage;
    }

    public void setSyncWithMeetingPackage(Boolean syncWithMeetingPackage) {
        this.syncWithMeetingPackage = syncWithMeetingPackage;
    }
    ...
    public Boolean getCreatePMSBlock() {
        return createPMSBlock;
    }

    public void setCreatePMSBlock(Boolean createPMSBlock) {
        this.createPMSBlock = createPMSBlock;
    }
    ...
    public Boolean getPmsWarning() {
        return pmsWarning;
    }

    public void setPmsWarning(Boolean pmsWarning) {
        this.pmsWarning = pmsWarning;
    }
    ...
    public Boolean getIndividualPickup() {
        return individualPickup;
    }

    public void setIndividualPickup(Boolean individualPickup) {
        this.individualPickup = individualPickup;
    }

    public Boolean getSendFailedPMSBlock() {

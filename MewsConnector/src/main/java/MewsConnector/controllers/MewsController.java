...
public class MewsController {
    ...
    public MewsCompanyRequest createCompanyPayload(String notes,String name ,SalesforceAccountResponse account,SalesforceContactResponse contact) throws JsonProcessingException {
    ...
    System.out.println(name);
        ...
        mewsCompanyRequest.setName(name);
        ...
        mewsCompanyRequest.setNotes(notes);
